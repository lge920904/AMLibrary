...
//    public static final String PORT = "";
    public static final String CONTEXT_FRAD = "hw" + URL_SEPARATOR + "frad"
            + URL_SEPARATOR;
    public static final String CONTEXT_AD = "hw" + URL_SEPARATOR + "ad"
            + URL_SEPARATOR;
    public static final String DOMAIN = "http://85114.com";
    public static final String URL_ROOT_FRAD = DOMAIN + URL_SEPARATOR
            + CONTEXT_FRAD;
    public static final String URL_ROOT_AD = DOMAIN + URL_SEPARATOR
            + CONTEXT_AD;
